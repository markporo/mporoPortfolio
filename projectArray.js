...
export const projects = [
  { src: newPortfolio, id: 10, title: "This Portfolio", alt: "mporo portfolio", githubUrl: "https://github.com/markporo/mporoPortfolio", liveUrl: "https://mporo.netlify.app/", description: "My redesigned portfolio where you can view some of the projects I have worked on!  It is mostly built upon by Next.Js and Tailwind" },
  ...
  { src: wedding, id: 2, title: "The Wedding", alt: "M + S: THE WEDDING", githubUrl: "https://github.com/markporo/theWedding", liveUrl: "https://young-savannah-18383.herokuapp.com/", description: "This was a special project for obvious reasons. Before I joined a coding boot camp I built this with strictly HTML, CSS, Javascript, and Mongoose/ Mongo DB.  The main feature includes an RSVP form that allowed guests to submit data.  Try it out with the name --Mark Porostosky!" },
  ...
  { src: poro, id: 4, title: "Music Site", alt: "Poro Music", githubUrl: "https://github.com/markporo/poro-website", liveUrl: "https://poromusic.com/", description: "This is a responsive and clean looking band website!  It utilizes HTML/ CSS and Javascript. It is designed with a custom layout and deployed via Netlify." },
